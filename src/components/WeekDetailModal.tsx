								...
								>
									...
									<div className="col-span-5 grid grid-cols-4 gap-2 px-4 border-l border-r border-white/5">
										<div className="text-center">
											<p className="text-[7px] font-black text-slate-600 uppercase mb-1">
												Base Teórica
											</p>
											<p className="text-[10px] font-black text-slate-300 font-mono">
												{formatCurrency(s.theoreticalBase)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-[7px] font-black text-crimson uppercase mb-1">
												Faltas ({6 - (s.daysWorked + s.holidaysWorked)})
											</p>
											<p className="text-[10px] font-black text-crimson/80 font-mono">
												-{formatCurrency(s.unpaidDaysAmount || 0)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-[7px] font-black text-rose-400 uppercase mb-1">
												Feriados ({s.holidaysWorked})
											</p>
											<p className="text-[10px] font-black text-rose-400/80 font-mono">
												+{formatCurrency(s.holidayExtraPay || 0)}
											</p>
										</div>
										<div className="text-center">
											<p className="text-[7px] font-black text-electric uppercase mb-1">
												H. Extras ({s.extraHoursCount || 0})
											</p>
											<p className="text-[10px] font-black text-electric/80 font-mono">
									...
									<div className="col-span-1 text-center">
										<p className="text-emerald text-xs font-black font-mono">
									...
									<div className="col-span-1 flex flex-col items-center gap-1">
										...
										{!s.loanDeduction && !s.penalizationDeduction && (
											<span className="text-[7px] font-black text-slate-800 uppercase italic">
												Limpio
											</span>
										)}
									</div>
									...
									<div className="col-span-2 text-right">
										<div className="flex flex-col items-end">
											<p className="text-white text-xl font-black italic font-mono tracking-tighter">
